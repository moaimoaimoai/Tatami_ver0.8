...
const Following = () => {
    ...
    // console.log("Folowing", followinguser);
    const listProfiles =
        profile.id &&
                                ...
                                <div className='card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl'>
                                    ...
                                    <div className='card-body d-block w-100 shadow-none mb-0 p-0 border-top-xs'>
                                        <ul className='nav nav-tabs h55 d-flex product-info-tab border-bottom-0 ps-4' id="pills-tab" role="tablist" >
                                            ...
                                            <li className="active list-inline-item me-5"><Link className="active fw-700 font-xssss text-grey-500 pt-3 pb-3 ls-1 d-inline-block" to="/following" data-toggle="tab">フォロー</Link></li>
