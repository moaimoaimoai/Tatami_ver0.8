              ...
              <ul className="mb-1 top-content">
                ...
                <li>
                  <Link to="/recommend" className="nav-content-bttn open-font">
                    <i className="feather-zap btn-round-md bg-gold-gradiant me-3"></i>
                    <span>Topics</span>
                  </Link>
                </li>
                <li>
                  ...
                  >
                    <i className="feather-user btn-round-md bg-success me-3"></i>
                    <span>Users</span>
                  </Link>
                </li>
                ...
                <li>
                  <Link to="/home" className="nav-content-bttn open-font">
                    <i className="feather-home btn-round-md bg-orange me-3"></i>
                    <span>Home</span>
                  </Link>
                </li>
              </ul>
