...
const Appfooter = () => {
  ...
  return (
    <div className="app-footer border-0 shadow-lg bg-primary-gradiant">
      ...
      <Link to="/recommend" className="nav-content-bttn">
        <i className="feather-trending-up"></i>
      </Link>
      <Link to="/recommenduser" className="nav-content-bttn" data-tab="chats">
        <i className="feather-user"></i>
      </Link>
      <Link to="/owningpages" className="nav-content-bttn">
